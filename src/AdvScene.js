...
class NextButton extends Container {
  constructor(scene, x = 0, y = 0) {
    ...
    (t.hitGra = scene.add.graphics()),
      ...
      t.flashCover.fillRect(0, 0, constants.GAME_WIDTH, constants.GAME_HEIGHT),
...
export default class AdvScene extends Scene {
  ...
  create() {
    ...
    (this.txtBg = this.add.graphics()),
      ...
      this.txtBg.strokeRoundedRect(
        8,
        constants.GAME_MIDDLE + 7,
        constants.GAME_WIDTH - 16,
        180,
        6
      ),
      (this.txt = this.add.text(
        15,
        constants.GAME_MIDDLE + 30,
        " ",
        textStyle
      )),
      ...
      this.nameBg.strokeRoundedRect(0, 0, 80, 24, 6),
      (this.nameBg.x = 16),
